...
function GoogleCityStateCountryDetails() {
    const [category, setCategory] = useState("administrative_area_level_1,country,administrative_area_level_3,locality");
            ...
            <div className="card shadow rounded-3">
                <div className="card-body p-4">
                    ...
                    {isLoading ? (
                        ...
                        <div className="text-center text-muted py-4 mt-5 fs-6">
...
export default GoogleCityStateCountryDetails